...
LOGIN_REDIRECT_URL = 'bids:index'


EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_USE_TLS = True
EMAIL_HOST = 'mail.binary-apps.com'
EMAIL_HOST_USER = 'no-reply@binary-apps.com'
EMAIL_HOST_PASSWORD = 'tatendah095'
EMAIL_PORT = 465
DEFAULT_FROM_EMAIL = 'no-reply@binary-apps.com'